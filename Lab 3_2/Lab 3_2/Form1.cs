...
namespace Lab_3_2
{
    ...
    {
        private int vbo_position = 0;
        private int BasicProgramID = 0;
        ...
        private void setVec4BufferAsImage(Vector4[] array, BufferUsageHint bufferUsageHint, int unit)
        {
            ...
            GL.BufferData(
                ...
                (IntPtr)(sizeof(float) * 4 * array.Length),
        ...
        {
            GL.Viewport(
                0, 0, glControl1.Width,
                (glControl1.Height == 0) ? 1 : glControl1.Height
            );
            initShaders();
        }
        ...
        {
            glControl1.Width = this.ClientRectangle.Width - 30;
            glControl1.Height = this.ClientRectangle.Height - 30;
        }
